...
// toast.success(response.data.message)
  ...
  return (
    <div className='add'>
      <form onSubmit={onSubmitHadler} className='flex-col'>
   ...
   <div className="add-product-description flex-col">
    ...
    <textarea onChange={onChangeHandler} value={data.description} rows='10' name='description' placeholder='Type here' required/>
   </div>
